...
public abstract class DynoMEMMixinConfig implements IMixinConfigPlugin {
    protected static final Logger LOGGER = LogManager.getLogger("dynomem-mixin");
    ...
    private final DynoMEMConfig.Option enableOption;
    private final LithiumSupportState lithiumState;
    private final boolean optIn;

    protected DynoMEMMixinConfig(
            DynoMEMConfig.Option enableOption, LithiumSupportState lithiumCompat, boolean optIn
    ) {
    ...
    protected DynoMEMMixinConfig(DynoMEMConfig.Option enableOption) {
